...
| Quickclot | - 1 part Kelotane<br> - 1 part Croneoxadone<br> | Slows down bleeding by a signifigant amount. | -5 | 0.1u/s in blood,<br> 0.05u/s in stomach | 5u | Overdosing on Quickclot makes the patient completely immune to bleeding. Internal wounds caused by Brute damage can be cured by a high overall bloodclot effect, so overdosing on Quickclot can cure these wounds. |
| ---- | ------ | ------ | --- | ---------- | -------- | ---- |
## Advanced Medicines
