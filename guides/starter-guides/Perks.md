...
| Aulvae | Caloric Redline | by burning through mass at an excessive rate an Aulvae can push their body to move with surprising swiftness, albeit losing some of the fine control over their movements. | Activate to inject yourself with 5 units of Slime Speed, a special chemical, increasing your speed by 60% for a short period and consuming your nutrition while reducing your Vig and Bio by 45 for a minute. 10 minute cooldown. Costs 200 nutrition to use. 
| Aulvae | Hypermytosis | By expending an extraordinary amount of energy you can kick your natural regeneration into high-gear, regenerating limbs and improving healing. This process must be done slowly and carefuly to avoid the risk of DNA damage and thus slows you down and limits consciousness. | Activate to inject yourself with 10 units of Mitosis Hyperstim, an otherwise-unobtainable chemical that regrows one of your missing limbs and heals organ damage at the cost of slowdown and reducing your consciousness level for a few minutes. 5 minute cooldown. Costs 450 nutrition.
| Aulvae | Malleable Mind | Expend some of your spare calories to greatly improve your intellect. | Boosts Bio, Cog, and Mec by 45 for 1 minute. 10 minute cooldown. Costs 200 nutrition to use. 
| Chtmant | Chitin Armor | Unlike other caste in the cht'mant hive you are built for combat, while not as naturally tough as other species you can tank a few more blows than your softer insectile brethren. | You take 20% less fall damage, 20% less brute damage, and have 5 bomb protection. 
| Chtmant | Kin to the Spiders | Through a combination of pheromones, appearance, and an innate understanding of spider behavior all spiders are friendly to you, they won't attack you even if you attack them. This change in your biology and pheromones however make you an enemy to roaches. As a side effect of dealing with spiders so often, you can't be slowed or stuck by webbing. | Spiders become nonhostile to you. Additionally, you don't get stuck or slowed when walking through webbing. 
| Chtmant | Produce Ichor | As a member of the Ru caste your ability to produce chemicals is well known, though it takes an hour to recover and much of your nutritional in-take you can produce clumped ichors that function as medical kits. | Spawns a brute-healing ichor, a burn-healing ichor, and a toxin-healing ichor. 1 hour cooldown. Requires 350 nutrition to use.
| Chtmant | Produce Repair Goo | Fixing things is apart of your caste as it is scuttling around keeping yourself busy. As such you can vomit out glue-like goo that functions exceptionally well for tool and general repairs. | Activate to spawn a stack of repair goo, much like a stack of duct tape. 1 hour cooldown. Requires 350 nutrients to activate.
| Chtmant | Scuttlebug | While your definitive purpose is not as clearly defined as other castes within the cht'mant hive your constant movement and labors have made you quite used to the hustle and bustle, letting you run faster than most races. | You move 30% faster. 
| Chtmant | Spin Webs | You can spin webs, spreading them around a location as a form of snaring barricade. | Activate this perk to spawn webs underneath you after a short delay. 5 second cooldown. 
...
| Folken | Folken Healing | As a Folken, you can use the light to heal wounds, standing in areas of bright light will increase your natural regeneration. | You heal 0.5 damage per second when standing in lit areas. 
...
| Mycus | Mushroom Follower | Shroomlings are animal-intelligence mycus capable of following simple orders like 'Shroomling 'Name' Follow.' and 'Shroomling 'Name' Stop.' who will stay by you when ordered. While capable of fighting, they are quite weak, the major benefit of having one is they may turn any food you feed into them into useful healing chemicals contained in bottles of resin. | Use to spawn a shroomling.  
| Mycus | Mycus Regeneration | As a mycus, you heal as long as you are in the darkness, increasing your natural regeneration. | You heal 0.5 damage per second when standing in darkness. 
| Mycus | Slime Follower | Slime-mold shroomlings are animal-intelligence mycus capable of following simple orders like 'Slime-Mold 'Name' Follow.' and 'Slimd-Mold 'Name' Stop.' who will stay by you when ordered. Slime-molds are made for combat, being incredibly sturdy and physically strong, able to regenerate even the worst wounds. Unfortunately they suffer from poor eyesight, requiring threats to get close before they notice them. | Use to spawn a slime follower.
...
| Opifex | Smuggled Armaments | You retrieve your custom kitted combat belt hidden on your person somewhere, along with the opifex-made black webbing vest that holds them. As every opifex is told, never go anywhere without your kit. This tool belt is yours alone and you should not allow any non-opifex to use it, nor the weapons within. | Provides a tactical belt filled with an energy gun and cells, manhack grenades, and other weapons and tools. 12 hour cooldown, so it is usually only usable once per round. 
| Opifex | Smuggled Circuit | Opifex are scavengers at heart and rely heavily on machines and AI as a result, as such, each opifex keeps a specially designed circuit on their person to build a make shift defense platform when needed to secure their safety. Sadly, you only managed to smuggle the circuit on your person. | Provides you with the circuit board for an Opifex Artificer Turret. 12 hour cooldown, so it is usually only usable once per round. 
| Opifex | Smuggled Medicine | You retrieve your custom kitted medical webbing hidden on your person somewhere, along with the opifex-made black webbing vest that holds them. As every opifex is told, never go anywhere without your kit. This tool belt is yours alone and you should not allow any non-opifex to use it. | Provides you with a high-end medical kit, including medication, a cryo bag, and splints. 12 hour cooldown, so it is usually only usable once per round. 
...
| Name | Description | Effect
|:-----|:------|:-------
| Blood Lust Aura | Your killing intent and wish for combat are felt by anything that attacks by instinct. When more simple-minded combatives evaluate you, they will target you immediately! | While active, you will be targeted first by mobs like roaches, spiders, and other hostiles. 
| Chem Addict | You've been an addict all your life, for whatever piss poor reason you've told yourself. Your body is able to handle a variety of drugs, more than the average person, but you get easily addicted to all of them. | You are twice as likely to become addicted to chemicals and drugs, but you gain +20 NSA. 
...
| Psionic Psychosis | You lived a life of unsettled violence. Maybe it was circumstance, maybe it was necessity, or maybe you just liked hurting people. No matter the reason, your mind is attuned to bloody violence and your potential as a psion reflects that. No matter your stats or physical body, you always deal maximum damage when using scaling psionic weaponry you create. | Your psionic powers that deal damage always deal maximum damage. 
| Rough Life | Your past life has been one of turmoil and extremes and as a result has toughened you up severely. Environmental damage from falling or explosives have less of an effect on your toughened body. | You can't be pushed around by people walking or diving into you, you take only 60% as much fall damage as others, you gain 20 resistance to environmental sanity effects, and you gain 25 resistance to explosions.

## Homeworld Perks
A list of perks provided by your Homeworld selection in character creation. 
...
A list of perks provided by occupations. See the page for each job for a description of what perks they come with. 
<details>
  <summary>
Occupation Perk Table
  </summary>
...
| Channeling | You know how to channel spiritual energy during rituals. You gain additional skill points during group rituals, and have an increased regeneration of cruciform energy. | 
| Chemical Contraband | For reasons either fair or foul, you know how to easily identify certain kinds of illegal chemical contraband. | Allows you to see illegal reagents easly in containers, such as drugs, stimulants, etc. | 
| Codespeak | You know Marshal codes. | Allows you access to the Marshal Code language, accessed by X? | 
...
| Exotic Inspiration | The best ideas come from a mind not entirely sober, any alcohol will give you that much needed boost... somehow. | +5 Cognition, +10 Mechanical for a short time after drinking alcohol.
...
| Fast Fingers | Nothing is safe around your hands. You are a true kleptomaniac. Taking items off others makes no sound or prompts, provided its in their pockets, hands, or their ears. It's also quicker and you can slip pills into drinks unnoticed. | Allows you to take items out of peoples' hands, ear slots, and pockets without broadcasting it to chat. | 
| Gunsmith Master | You are a professional gunsmith, your knowledge allows to not only repair firearms but expertly craft them. This includes the machines required to do so, including the bullet fabricator. | 
| Handyman | Training by the Artificer's Guild has granted you the knowledge of how to take apart machines in the most efficient way possible, finding materials and supplies most people would miss. This training is taken further the more mechanically skilled or cognitively capable you are. | X
...
| Hyperzine Injectors | A standard issue injector hidden away that is designed for Surface Operations Managers that contains a small on-demand injection of Hyperzine. The injector itself is unable to be seen by prying scanners and comes in both metal and organic material designs to aid in remaining hidden. While useful, the chemical storage takes time to recharge after use. | Injects you with 5 units of Hyperzine on use, a chemical that makes you move faster. Has a 15 minute recharge time.
| Immovable Object | Your intense training has perfected your footing, and you're an expert at holding the line. Few things can knock you off balance or push you around. | You can't be pushed around by others walking into you, you aren't stunned from falls, and you can't be knocked over by being shoved.
...
| Klutz | You find a lot of tasks a little beyond your ability to perform such as using any type of weaponry, but being accident prone has at least made you used to getting hurt. | Many attacks, time-consuming actions, and similar activities have a chance to fail, and weaponry may backfire on you.
...
| Spice up Food | Your own special, secret touch in seasoning has anomalous properties that can enhance most food products. | Allows you to season foods, randomly giving it a buff to a stat, more nutriment, or other bonuses. 
...
| True Faith | When near an obelisk, you feel your mind at ease. Your body is strengthened by its presence, resisting all forms of damage. | You gain 1.5 times as much sanity as others.
