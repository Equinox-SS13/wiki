...
* [Post Revival Sickness]() drastically reduces all stats permanently after being revived from death, this scales up the more stats you have.
...
| Computer Crafting | Computers, computer parts, and various other tools and weapons. Includes simple assemblies igniters and timers.
| Hacking | Faster and better chance of tools with pulsing quality like the multitool. Allowing better chances of disarming active mines and hacking locks.
...
| Medical Crafting | Medical items, splints, bone braces, etc.
...
* With high enough `ROB`, allow removal of Joyeuse from the altar without a cruciform.
* With high enough `ROB`, allow the Assassin's Dagger to penetrate armor and inject the reagents.
* Faster time escaping from handcuffs.
...
* Vivification directly increases (or decreases) your [NSA](/guides/medical-guides/Guide-to-Medicine#neural-system-accumulation), which directly affects how many drugs you can take at the same time without side effects.

## Anatomy (ANA)
> As of August 23, 2024, Anatomy only increase your maximum health by 1 point per each of Anatomy point. 
{.is-warning}

Two kinds of people: Those with loaded guns, and those with twigs for arms.

* Anatomy directly increases (or decreases) your Health point, allowing your body to tolerate more punishment before enttering critical condition or dying. Unlike other stats, Anatomy cannot be leveled up by [Internalizing](/guides/starter-guides/Sanity-and-Insight#leveling-up)